...
def install_firefox(choice=True):
    if choice:
        ...
        'library', 'Firefox Setup 87.0.exe') if name == 'nt' else system('sudo pacman -Syy firefox || sudo apt-get install firefox || sudo emerge firefox || sudo rpm install firefox'))
