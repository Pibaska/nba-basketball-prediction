...
gen_parser.add_argument("-gmc", "--gen-mutation-chance", type=float, default=15,
                        help="Percentage that indicates the chance of a gene being mutated during reproduction.")
gen_parser.add_argument("-gmm", "--gen-mutation-magnitude", type=tuple, default=(-20, 20),
...
gen_parser.add_argument("-gmg", "--gen-max-generations", type=int, default=1000,
...
gen_parser.add_argument("-gri", "--gen_random_individuals", type=int, default=0,
